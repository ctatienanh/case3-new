                        ...
                        <ul class="collapse nav">
                            <li class="nav-item nav-item-arrow-down nav-hover-show-sub">
                                ...
                                <ul class="collapse nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="movies-blocks-sidebar-right.html">Blocks - Sidebar
                                            right</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="movies-posters-sidebar-right.html">Posters - Sidebar
                                            right</a>
                                    </li>
                                    <li class="nav-item">
                    ...
                    <li style="margin: 0 10px" class="nav-item nav-item-arrow-down nav-hover-show-sub">
                        <a class="nav-link" href="#">
                                <span id="userName" style="font-size: inherit">${username}
                                                        <img style="height: 25px;width: 25px ;border-radius: 50%;margin-left: 8px"
                                                             src="imgg/${img}"
                                                             alt="">
                                </span>
                        </a>
                        ...
                        <ul class="collapse nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/dichvu?action=edit ">Trang cá Nhân</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                                ...
                                <div class="d-over bg-highlight-bottom">
                                    ...
                                    <h4 class="entity-title" style="font-size: 20px;color:mediumturquoise;">
                                        <a class="content-link"
                                           href="/dichvu?action=movie&cinema=${f.tenPhim}&username=${username}">${f.tenPhim}</a>
                                    </h4>
                ...
                <div class="entity-poster" data-role="hover-wrap">
                    ...
                    <div class="d-over bg-theme-lighted collapse animated faster" data-show-class="fadeIn show"
                        ...
                        <div class="entity-play">
                            <a class="action-icon-theme action-icon-bordered rounded-circle" href="${f.trailer}"
                               data-magnific-popup="iframe">
                                <span class="icon-content"><i class="fas fa-play"></i></span>
                            </a>
                        </div>
                    ...
                    <div class="entity-category" style="display: flex">
                        <div style="display: flex;flex-direction: column">
                            <a class="content-link" href="movies-blocks.html"
                               style="line-height: 23px;text-transform: capitalize">Loại phim: ${f.loaiPhim}</a>
                            <a class="content-link" href="movies-blocks.html"
                               style="line-height: 23px;text-transform: capitalize">Quốc gia: ${f.quocGia}</a>
                            <a class="content-link" href="movies-blocks.html"
                               style="line-height: 23px;text-transform: capitalize">Ngày khởi
                                chiếu: ${f.ngayKhoiChieu}</a>
                        </div>
                        <div style="display: flex;flex-direction: column;margin-left: 23px">
                            <a class="content-link" href="movies-blocks.html"
                               style="line-height: 23px;text-transform: capitalize">Đạo diễn: ${f.daoDien}</a>
                            <a class="content-link" href="movies-blocks.html"
                               style="line-height: 23px;text-transform: capitalize">Diễn viên: ${f.dienVien}</a>
                            <a class="content-link" href="movies-blocks.html"
                               style="line-height: 23px;text-transform: capitalize">Nhà sản xuất: ${f.nhaSX}</a>
                        </div>
                    </div>
                    <div class="entity-info">
                        <div class="info-lines">
                            ...
                            <span class="logo-element">
                                <span class="logo-tape">
                                    <span class="svg-content svg-fill-theme"
                                          data-svg="./images/svg/logo-part.svg"></span>
                                </span>
                                <span class="logo-text text-uppercase">
                                    <span>M</span>emico</span>
                            </span>
